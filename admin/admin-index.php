...
<body>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified"   style=" font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-size:15px;font-weight:bold;">
    ...
    <li style="background-color: #9dc99d;"><a data-toggle="pill" href="#menu2" style=color:white;>Tenant Details</a></li>
    <li style="background-color: #9dc99d;"><a data-toggle="pill" href="#menu3" style=color:white;>Booked Property</a></li>
  </ul>
