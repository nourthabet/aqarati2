...
.form-group {
 ...
 <center><h3 style="font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;color: #426942;font-weight:bold;">Tenant Profile</h3></center>
      <div class="container">
      <?php 
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="form-group">
      ...
      <img src="<?php echo $rows['id_photo']; ?>" id="output_image"/ height="100px" readonly>
                ...
                <hr>
                <center><button id="submit" name="tenant_update" class="btn btn-primary btn-block" style="background-color: #426942;font-weight:bold;">Update</button></center><br>
